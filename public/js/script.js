...
var works = [{
    isbn: '0888994168',
    img: 'images/de_The_Breadwinner.jpg'
}, {
    isbn: '0888995199',
    img: 'images/de_Parvanas_journey.jpg'
}, {
    isbn: '0888995423',
    img: 'images/de_Mud_City.jpg'
}, {
    isbn: '1554982979',
    img: 'images/de_My_Name_Is_Parvana.jpg'
}, {
    isbn: '0888999593',
    img: 'images/de_The_Breadwinner_Trilogy.jpg'
}, {
    isbn: '0888997353',
    img: 'images/de_I_Am_A_Taxi.jpg'
}, {
    isbn: '0060531827',
    img: 'images/ko_Airborn.jpg'
}, {
    isbn: '0006481795',
    img: 'images/ko_Silverwing.jpg'
}, {
    isbn: '0060532297',
    img: 'images/ko_skybreaker.jpg'
}, {
    isbn: '1442403152',
    img: 'images/ko_this_dark_endeavor.jpg'
}, {
    isbn: '000648171X',
    img: 'images/ko_Sunwing.jpg'
}, {
    isbn: '1554681804',
    img: 'images/vg_not_suitable.jpg'
}, {
    isbn: '1551435667',
    img: 'images/vg_dead_end_job.jpg'
}, {
    isbn: '1551436434',
    img: 'images/vg_pigboy.jpg'
}, {
    isbn: '1554681820',
    img: 'images/vg_betsy_wickwire_.jpg'
}, {
    isbn: '1551433702',
    img: 'images/vg_quid_pro_quo.jpg'
}, {
    isbn: '1551436949',
    img: 'images/vg_id.jpeg'
}, {
    isbn: '1770494820',
    img: 'images/cy_Nancy_Knows.jpg'
}, {
    isbn: '1554535689',
    img: 'images/cy_Ten_Birds.jpg'
}, {
    isbn: '088899995X',
    img: 'images/cy_A_Few_Blocks.jpg'
}, {
    isbn: '1554983398',
    img: 'images/cy_Some_Things_We_Lost.jpg'
}, {
    isbn: '1894786602',
    img: 'images/cy_The_Queens_Shadow.jpg'
}, {
    isbn: '1554982952',
    img: 'images/cy_A_Few_Bites.jpg'
}, {
    isbn: '0888994044',
    img: 'images/Stella_Queen_Of_The_Snow.jpg'
}, {
    isbn: '0888995725',
    img: 'images/mlg_Stella_Star_Of_The_Sea.jpg'
}, {
    isbn: '1554983827',
    img: 'images/mlg_Any_Questions.jpg'
}, {
    isbn: '0888997108',
    ...
    isbn: '0888999941',
    img: 'images/mlg_Roslyn_Ruabaga_And_The_Biggest_Hole.jpg'
}];
...
childrenApp.init = function () {
    //Function to make ajax calls when author image or button are clicked
    $('.authorsClick, button').on('click', function (e) {
        ...
        //get author ID which is stored in data- attribute on the button to make the ajax call
...
//Pass author ID that we got from data- attribute to make the ajax call for each author
...
// Get book image URL from the API
...
// Regex to clean up the description that we got back from the API
...
// Image listener to get the book description stored in data- attribute on the corresponding image
var addImgListener = function addImgListener() {
...
var replaceDescription = function replaceDescription(bookTitle, bookDescription) {
...
// Home button to go back to main section
$('.home').click(function () {
    $('#content').hide();
    $('#main').show();
});
